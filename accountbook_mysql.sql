...
CREATE TABLE `deleted_expenses` (
  ...
  PRIMARY KEY (`id`),
  KEY `deleted_expenses_user_id_d561b87f_fk_users_id` (`user_id`),
  CONSTRAINT `deleted_expenses_user_id_d561b87f_fk_users_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `deleted_expenses_chk_1` CHECK ((`amount` >= 0))
...
-- Dump completed on 2022-01-21 23:51:51
